/*
 * include/linux/mms100_isc.h - ISC (In-system programming via I2C) enables
 * MMS-100 Series sensor to be programmed while installed in a complete system.
 *
 ...
 *			ex) Modify delay parameter constant to make it fit to
 *				your delay function such as mms100_usdelay()
 *				and mms100_msdelay()
 *           5. Rename 'uart_printf()' to your console print function for
 *			debugging.
...
/*
 *	Configure watch dog API of host system to disable interrupts from
 *	other devices during ISC mode
 */
 ...
 */
#if 0				/* NOT USED */
#define MMS100_VDD_SET_HIGH()	/* specify a detailed information of
				 * host system
				 */
#define MMS100_VDD_SET_LOW()	/* specify a detailed information of
				 * host system
				 */

#define MMS100_CE_SET_HIGH()	gpio_set_value(122, 1)
#define MMS100_CE_SET_LOW()	gpio_set_value(122, 0)
#define MMS100_CE_SET_OUTPUT()	/* specify a detailed information of
				 * host system
				 */

#define MMS100_INTR_SET_HIGH()	gpio_set_value(35, 1)
#define MMS100_INTR_SET_LOW()	gpio_set_value(35, 0)
#define MMS100_INTR_SET_OUTPUT()	/* specify a detailed information of
					 * host system
					 */
 ...
 */
#define mms100_usdelay(x) \
	do { \
		(x) > (MAX_UDELAY_MS * 1000) ? mdelay((x)/1000) : udelay(x); \
	} while (0)
...
/* See "static DEFINE_MUTEX(melfas_mutex);" with #if 1 as well */
#if 1
