...
/* UART1 */
#define GPIO47_UART1_RXD	MFP_CFG(GPIO47, AF6)
#define GPIO48_UART1_TXD	MFP_CFG(GPI048, AF6)

/*IRDA*/
//#define GPIO51_IRDA_SHDN	MFP_CFG(GPIO51, AF0)

/* SMC */
#define SM_nCS0_nCS0		MFP_CFG(SM_nCS0, AF1)
#define SM_nCS1_NCS1		MFP_CFG(SM_nCS1, AF1)
#define SM_ADV_SM_ADV		MFP_CFG(SM_ADV, AF1)
#define SM_SCLK_SM_SCLK		MFP_CFG(SM_SCLK, AF1)
#define SM_BE0_SM_BE0		MFP_CFG(SM_BE0, AF0)
#define SM_BE1_SM_BE1		MFP_CFG(SM_BE1, AF0)
